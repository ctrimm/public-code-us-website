...
featuredImageAlt: "The $640 million duplication problem: California, Illinois, and New York each built the same unemployment system from scratch"
---
...
That's **$640 million** to solve the same problem three times.
