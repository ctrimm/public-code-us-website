...
When they sued, the state of Idaho could not explain how the algorithm worked. The vendor claimed the formula was a trade secret. A federal court ultimately ruled that Idaho had violated residents' constitutional right to due process — because you cannot appeal a decision when you are not allowed to know the basis for it.

The court was right. But the case took years. The harm was already done. And the same type of system is still running in states across the country.
...
In 2023, a coalition of disability rights advocates sued Arkansas over its Medicaid home care algorithm — the same category of system as Idaho's, a different state, a decade later, the same outcome: unexplained cuts, appeals denied, a vendor claiming trade secrets. A federal judge found that Arkansas had violated due process.
